#!/bin/bash
# BONES — infrastructure-agnostic training launcher
#
...
#   bash <(curl -s https://codeberg.org/Ronin48/BONES/raw/branch/main/scripts/launch.sh)

set -e

REPO_URL="https://codeberg.org/Ronin48/BONES.git"
REPO_NAME="BONES"
...
ADAPTER_DIR="$REPO_DIR/output/bones-qlora/final"
HF_REPO="Ronin48LLC/bones-lora-adapter"
